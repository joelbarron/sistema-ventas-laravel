...
<html lang="es">
  <head>
    ...
    <title>UsbixVentas | www.usbix.com.mx</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{url('/home')}}" class="logo">
          ...
          <span class="logo-mini"><b>UB</b>V</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>UsbixVentas</b></span>
        </a>
...
<!--                   <small class="bg-red">Online</small>
 -->                  <span class="hidden-xs">Joel Barron Hernandez</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <!-- <li class="user-header">
                    ...
                    <p>
                      www.usbix.com.mx - Desarrollando Software
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2020 <a href="{{ url('www.usbix.com.mx')}}">Usbix</a>.</strong> All rights reserved.
      </footer>
